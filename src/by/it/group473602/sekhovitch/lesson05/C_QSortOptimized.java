...
public class C_QSortOptimized {
    ...
    public static void quicksort (Segment[] array, int b, int e)
    {
        int l = b, r = e;
        Segment basic = array[(l + r) / 2]; // Опорным элементом для примера возьмём средний
        while (l <= r)
        {
            while (array[l].compareTo(basic) == -1)
                l++;
            while (array[l].compareTo(basic) == 1)
                r--;
            if (l <= r)
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group473602/sekhovitch/lesson05/dataC.txt");
